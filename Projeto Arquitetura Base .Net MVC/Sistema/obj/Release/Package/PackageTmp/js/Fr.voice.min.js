...
*/
!function(t){t.Fr=t.Fr||{},Fr.voice={workerPath:"~/js/recorderWorker.js",mp3WorkerPath:"~/js/mp3Worker.js",stream:!1,init_called:!1,init:function(){try{t.AudioContext=t.AudioContext||t.webkitAudioContext,navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia,t.URL=t.URL||t.webkitURL,navigator.getUserMedia===!1&&alert("getUserMedia() is not supported in your browser"),this.context=new AudioContext}catch(e){alert("Web Audio API is not supported in this browser")}},record:function(t,e){e=e||function(){},this.init_called===!1&&(this.init(),this.init_called=!0),$that=this,navigator.getUserMedia({audio:!0},function(r){var o=$that.context.createMediaStreamSource(r);t===!0&&o.connect($that.context.destination),$that.recorder=new Recorder(o,{workerPath:$that.workerPath,mp3WorkerPath:$that.mp3WorkerPath}),$that.stream=r,$that.recorder.record(),e(r)},function(){alert("No live audio input")})},pause:function(){this.recorder.stop()},resume:function(){this.recorder.record()},stop:function(){return this.recorder.stop(),this},"export":function(e,r){"mp3"==r?this.recorder.exportMP3(e):this.recorder.exportWAV(function(o){if(""==r||"blob"==r)e(o);else if("base64"==r){var i=new t.FileReader;i.readAsDataURL(o),i.onloadend=function(){base64data=i.result,e(base64data)}}else if("URL"==r){var a=URL.createObjectURL(o);e(a)}})}}}(window);
